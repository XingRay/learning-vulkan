...
namespace model_loader_test {
    ...
    void ModelLoaderTest::initWindow() {
        glfwInit();
    ...
    void ModelLoaderTest::initVulkan() {
        createInstance();
        setupDebugMessenger();
        createSurface();
        pickPhysicalDevice();
    ...
    void ModelLoaderTest::createInstance() {
...
//    }
    ...
    bool ModelLoaderTest::checkValidationLayerSupported() {
...
//    return true;
    ...
    std::vector<const char *> ModelLoaderTest::getRequiredExtensions() {
    ...
    void ModelLoaderTest::destroyDebugUtilsMessengerExt(const vk::AllocationCallbacks *pAllocator) {
        DestroyDebugUtilsMessengerEXT(mInstance, mDebugMessenger, pAllocator);
    }

    void ModelLoaderTest::setupDebugMessenger() {
    ...
    void ModelLoaderTest::pickPhysicalDevice() {
...
//    }
    ...
    bool ModelLoaderTest::isDeviceSuitable(vk::PhysicalDevice device) {
        ...
        if (!isDeviceSupportedRequiredExtensions(device)) {
            std::cout << "isDeviceSupportedRequiredDeviceExtensions: false" << std::endl;
            return false;
        }
...
//    vk::PhysicalDeviceType::eDiscreteGpu;
    ...
    int ModelLoaderTest::rateDeviceSuitability(vk::PhysicalDevice device) {
        int score = 0;
...
//    vkGetPhysicalDeviceFeatures(device, &deviceFeatures);
    ...
    void ModelLoaderTest::createLogicalDevice() {
    ...
    QueueFamilyIndices ModelLoaderTest::findQueueFamilies(vk::PhysicalDevice &device) {
    ...
    void ModelLoaderTest::createSurface() {
    ...
    bool ModelLoaderTest::isDeviceSupportedRequiredExtensions(vk::PhysicalDevice device) {
    ...
    SwapChainSupportDetail ModelLoaderTest::querySwapChainSupported(vk::PhysicalDevice &device) {
    ...
    vk::SurfaceFormatKHR ModelLoaderTest::chooseSwapSurfaceFormat(const std::vector<vk::SurfaceFormatKHR> &availableFormats) {
    ...
    vk::PresentModeKHR ModelLoaderTest::choosePresentMode(const std::vector<vk::PresentModeKHR> &availablePresentModes) {
    ...
    vk::Extent2D ModelLoaderTest::chooseSwapExtent(const vk::SurfaceCapabilitiesKHR &capability) {
    ...
    void ModelLoaderTest::createSwapChain() {
        ...
        if (queueFamilyIndices.graphicQueueFamily == queueFamilyIndices.presentQueueFamily) {
            ...
            createInfo.setPQueueFamilyIndices(&queueFamilyIndices.graphicQueueFamily.value());
        } else {
            // 2个队列
    ...
    void ModelLoaderTest::createImageViews() {
    ...
    void ModelLoaderTest::cleanImageViews() {
        for (const auto &imageView: mSwapChainImageViews) {
            mDevice.destroy(imageView);
        }
    }

    void ModelLoaderTest::createRenderPass() {
        vk::AttachmentDescription colorAttachmentDescription{};
        colorAttachmentDescription
                .setFormat(mSwapChainImageFormat.format)
...
//            .setPDependencies(&subpassDependency);
    ...
    void ModelLoaderTest::createGraphicsPipeline() {
        auto vertexShaderCode = FileUtil::readFile("../output/shader/03_3d_model/vertex.spv");
        auto fragmentShaderCode = FileUtil::readFile("../output/shader/03_3d_model/fragment.spv");
...
//    colorBlendAttachmentState.setAlphaBlendOp(vk::BlendOp::eAdd);
    ...
    vk::ShaderModule ModelLoaderTest::createShaderModule(const std::vector<char> &code) {
    ...
    void ModelLoaderTest::createFrameBuffers() {
...
//                .setAttachmentCount(attachments.size())
    ...
    void ModelLoaderTest::createCommandPool() {
        QueueFamilyIndices queueFamilyIndices = findQueueFamilies(mPhysicalDevice);
    ...
    void ModelLoaderTest::createCommandBuffers() {
    ...
    void ModelLoaderTest::recordCommandBuffer(const vk::CommandBuffer &commandBuffer, uint32_t imageIndex) {
...
//        commandBuffer.draw(mVertices.size(), 1, 0, 0);
    ...
    void ModelLoaderTest::drawFrame() {
...
//    std::cout << "presentKHR eSuccess" << std::endl;
    ...
    void ModelLoaderTest::cleanFrameBuffers() {
...
//    });
    ...
    void ModelLoaderTest::createSyncObjects() {
    ...
    void ModelLoaderTest::cleanSyncObjects() {
        for (int i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
    ...
    void ModelLoaderTest::recreateSwapChain() {
        // 处理最小化
        int width;
        int height;
        glfwGetFramebufferSize(mWindow, &width, &height);
    ...
    void ModelLoaderTest::cleanUpSwapChain() {
        cleanFrameBuffers();
        cleanColorResources();
        cleanDepthResources();
        cleanImageViews();
    ...
    void ModelLoaderTest::createVertexBuffer() {
    ...
    void ModelLoaderTest::createIndexBuffer() {
    ...
    uint32_t ModelLoaderTest::findMemoryType(uint32_t typeFilter, vk::MemoryPropertyFlags properties) {
    ...
    std::pair<vk::Buffer, vk::DeviceMemory> ModelLoaderTest::createBuffer(vk::DeviceSize size, vk::BufferUsageFlags usage, vk::MemoryPropertyFlags properties) {
    ...
    void ModelLoaderTest::copyBuffer(vk::Buffer srcBuffer, vk::Buffer dstBuffer, vk::DeviceSize size) {
    ...
    void ModelLoaderTest::createDescriptorSetLayout() {
...
//            .setBindingCount(bindings.size())
    ...
    void ModelLoaderTest::createUniformBuffers() {
    ...
    void ModelLoaderTest::cleanUniformBuffers() {
        for (int i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
    ...
    void ModelLoaderTest::updateUniformBuffer(uint32_t frameIndex) {
    ...
    void ModelLoaderTest::createDescriptorPool() {
...
//            .setFlags(vk::DescriptorPoolCreateFlagBits::eFreeDescriptorSet);
    ...
    void ModelLoaderTest::createDescriptorSets() {
...
//    mDescriptorSets.resize(MAX_FRAMES_IN_FLIGHT);
    ...
    void ModelLoaderTest::createTextureImage() {
...
//                          vk::ImageLayout::eShaderReadOnlyOptimal, mMipLevels);
    ...
    ModelLoaderTest::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, vk::SampleCountFlagBits numSamples,
...
//    vk::DeviceSize imageSize = textureWidth * textureHeight * 4;
    ...
    vk::CommandBuffer ModelLoaderTest::beginSingleTimeCommands() {
        vk::CommandBufferAllocateInfo commandBufferAllocateInfo{};
    ...
    void ModelLoaderTest::endSingleTimeCommands(vk::CommandBuffer &commandBuffer) {
        commandBuffer.end();
    ...
    void ModelLoaderTest::transitionImageLayout(vk::Image image, vk::Format format, vk::ImageLayout oldImageLayout, vk::ImageLayout newImageLayout, uint32_t mipLevels) {
        vk::CommandBuffer commandBuffer = beginSingleTimeCommands();
        {
...
//                .setDstAccessMask(static_cast<vk::AccessFlags>(0));
    ...
    void ModelLoaderTest::copyBufferToImage(vk::Buffer buffer, vk::Image image, uint32_t width, uint32_t height) {
        vk::CommandBuffer commandBuffer = beginSingleTimeCommands();
    ...
    void ModelLoaderTest::createTextureImageView() {
        mTextureImageView = createImageView(mTextureImage, vk::Format::eR8G8B8A8Srgb, vk::ImageAspectFlagBits::eColor, mMipLevels);
    }

    vk::ImageView ModelLoaderTest::createImageView(const vk::Image &image, vk::Format format, vk::ImageAspectFlags imageAspect, uint32_t mipLevels) {
...
//            .setComponents(componentMapping);
    ...
    void ModelLoaderTest::createTextureSampler() {
...
//            .setMinLod(static_cast<float >(mMipLevels / 2))
    ...
    void ModelLoaderTest::createDepthResources() {
...
//    vk::FormatFeatureFlags formatFeatureFlags;
    ...
    vk::Format ModelLoaderTest::findSupportedFormat(const std::vector<vk::Format> &candidates, vk::ImageTiling tiling, vk::FormatFeatureFlags features) {
    ...
    vk::Format ModelLoaderTest::findDepthFormat() {
    ...
    bool ModelLoaderTest::hasStencilComponent(vk::Format format) {
        return format == vk::Format::eD32SfloatS8Uint || format == vk::Format::eD24UnormS8Uint;
    }

    void ModelLoaderTest::cleanDepthResources() {
        mDevice.destroy(mDepthImage);
        mDevice.destroy(mDepthImageView);
        mDevice.freeMemory(mDepthDeviceMemory);
    }

    void ModelLoaderTest::loadModel() {
    ...
    void ModelLoaderTest::generateMipmaps(vk::Image image, vk::Format imageFormat, int textureWidth, int textureHeight, uint32_t mipLevels) {
    ...
    vk::SampleCountFlagBits ModelLoaderTest::getMaxUsableSampleCount() {
        vk::PhysicalDeviceProperties properties = mPhysicalDevice.getProperties();
    ...
    void ModelLoaderTest::createColorResources() {
    ...
    void ModelLoaderTest::cleanColorResources() {
